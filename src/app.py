...
from flask_swagger import swagger,api
...
def get_people():
    people = People.query.all()  # Query all records in the People table
...
# Endpoint para recuperar  persona de la base de datos
...
# Endpoint to get all vehicles from the database.
